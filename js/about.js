const teamMembers = [
        {
          ...
          social: {
            ...
            linkedin: "https://www.linkedin.com/in/rujal-sharma-rajopadhyaya-67811128a/"
          }
        },
        {
          name: "Dibika Dahal",
            ...
            <div class="card-content">
              ...
              <div class="member-info">
                ...
                <div class="social-links">
                  <a href="${member.social.github}" class="social-link" title="GitHub" target="_blank">
                  ...
                  <a href="${member.social.linkedin}" class="social-link" title="LinkedIn" target="_blank">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
